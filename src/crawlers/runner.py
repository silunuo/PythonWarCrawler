...
def crawl_all(config: AppConfig, target_total: int, smoke: bool = False) -> list[Comment]:
    smoke_target = int(config.get("crawl", "smoke_target_per_platform", default=10))
    per_platform = smoke_target if smoke else ceil(target_total / 3)
